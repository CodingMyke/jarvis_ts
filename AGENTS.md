...
- Do not use local render helper functions that return JSX for structured UI blocks with their own responsibility; extract a dedicated file-based component instead.
