...
export function Button({
  ...
  const baseStyles =
    "cursor-pointer flex items-center justify-center rounded-xl border px-3 py-2 transition-[background-color,border-color,text-color,opacity,transform] duration-(--transition-fast) focus:outline-none focus:ring-2 disabled:opacity-50";
